document.addEventListener('DOMContentLoaded', () => {
    ...
    // Controlled Scrolling - One page at a time without blocking interactions
    let isScrolling = false;
    let touchStartY = 0;
    let currentSectionIndex = 0;

    // Handle wheel events (desktop) - passive to not block
    ...
    // Handle touch events (mobile) - non-blocking
    ...
    slider.addEventListener('touchmove', (e) => {
        ...
        // Only trigger if swipe is significant (more than 80px) and not already scrolling
    ...
    // Update current section index when scrolling completes
